...
export const RESOURCES: Record<string, ResourceConfig> = {
  ...
  ammo: {
    ...
    fields: [
      ...
      { name: 'bulletType', label: 'Bullet type', type: 'select', options: [
        { value: 'FMJ', label: 'Full Metal Jacket (FMJ)' },
        { value: 'JHP', label: 'Jacketed Hollow Point (JHP)' },
        { value: 'HP', label: 'Hollow Point (HP)' },
        { value: 'SP', label: 'Soft Point (SP)' },
